...
[assembly: InternalsVisibleTo("XperiencesAI.SDK.Test")]
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is AgentStatus agentStatus)
                return AgentStatusValueConverter.ToJsonValue(agentStatus);
            if (obj is MessageRole messageRole)
                return MessageRoleValueConverter.ToJsonValue(messageRole);
